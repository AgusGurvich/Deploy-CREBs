...
app.use((req,res,next) => {
    ...
    app.locals.mensaje = req.flash('mensaje'); // Una vez almacenado un mensaje, voy a agarrar ese mensaje y hacerlo disponible en todas mis vistas. Luego tengo que preguntar por ese mensaje en todas las vistas.
